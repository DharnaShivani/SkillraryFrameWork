...
/**
 * This class contains all resusable methods to perform driver related operations
 * @author shivani
 */
...
public class WebDriverUtility {
	...
	/**
	 * This method is used to lanuch specified browser and maximize it
	 * @param browser
	 * @return
	 */
  ...
  /**
   * This method is used to wait until title apperas on the web page
   * @param time
   * @param title
   * @return
   */
  ...
  /**
   * public void deselectFromDropdown(WebElement element,int index) {
	  Deselect deselect = new Deselect(element);
	  deselect.deselectByIndex(index);
  }
  public void deselectFromDropdown(WebElement element,String value) {
	  Deselect deselect = new Deselect(element);
	  deselect.deselectByValue(value);
  }
  public void deselectFromDropdown(String text,WebElement element) {
	  Deselect deselect = new Deselect(element);
  ...
  /**
   * This method is used switch to child browser
   */
